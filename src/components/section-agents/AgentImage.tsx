...
const AgentImage: FC = () => {
  ...
  const img = <img src={AgentImg} alt="reyana" width={450} height={900} />;
  return (
    <div className="lg:w-full lg:max-w-[40%]">
      <div className="relative mt-5 z-20">
        <div className="pt-[100%] md:pt-[80%] lg:pt-[106%]"></div>
        <div
          className="absolute h-full 
        -top-[5%] sm:top-0 md:-top-[5%] lg:top-[45%]
        w-[83%] sm:w-[75%] md:w-[68%] lg:w-[125%]
        left-[10%] sm:left-[12%] md:left-[20%] lg:-left-[15%]"
        >
